-- Seed data for invoice analytics semantic PoC

USE CATALOG cfascdodev_primary;

INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.dim_supplier_semantic_poc
SELECT * FROM VALUES
...
INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.dim_item_semantic_poc
SELECT * FROM VALUES
...
INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.dim_restaurant_semantic_poc
SELECT * FROM VALUES
...
INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.dim_dc_semantic_poc
SELECT * FROM VALUES
...
INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.dim_date_semantic_poc
SELECT * FROM VALUES
...
INSERT OVERWRITE `cfascdodev_primary`.`invoice_gold_semantic_poc`.fact_invoice_line_semantic_poc
